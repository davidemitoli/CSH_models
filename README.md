## 🪨🪨🪨 Overview 🪨🪨🪨
This repository contains supporting information for the article titled "_Title_" published in . The dataset includes CIF (Crystallographic Information File) and XYZ (Cartesian coordinate file) formats relevant to the research presented in the article.
